          ...
          {(userData?.nivel_acesso === 'admin' || userData?.nivel_acesso === 'cargo') && (
            <>
              ...
              <div className="border-t border-blue-700 mt-2 pt-2">
                ...
                {console.log('🔍 RENDER Presença:', { userData, is_admin: userData?.is_admin, pode_editar_presenca: userData?.pode_editar_presenca, resultado: (userData?.is_admin || userData?.pode_editar_presenca) })}
