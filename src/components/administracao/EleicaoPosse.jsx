...
// Usa biblioteca 'docx' (npm) — deve estar no package.json do projeto
...
// Margens originais do documento modelo (DXA)
const DOC_CFG = {
  W: 11906, H: 16838,
...
const gerarDocx = async (tipo, eleicao, chapas, presencas, dadosLoja, irmaos) => {
  ...
  const prV = () => pr([ar('')], { before: 0, after: 0 });
  ...
  const cabecalho = () => [
    ...
    prC([
      ...
      ar('∴', { size: 26 }),
      ar(, { bold: true, size: 26 }),
    ], { before: 0, after: 40, line: 276 }),
    prC([ar(, { bold: true, size: 22 })], { before: 0, after: 40 }),
  ...
  // ═══════════════════════════════════════════════
    ...
    children = [
      pr([
        ...
        ar(' DA AUGUSTA E RESPEITÁVEL LOJA SIMBÓLICA ', { bold: true }),
        ar(, { bold: true }),
        ar(gestao, { bold: true }),
  ...
  // ═══════════════════════════════════════════════
    ...
    children = [
      pr([
        ...
        ar(' DA DIRETORIA DA AUGUSTA E RESPEITÁVEL LOJA SIMBÓLICA ', { bold: true }),
        ar(, { bold: true }),
        ar(gestao, { bold: true }),
      ], { align: AlignmentType.CENTER, before: 0, after: 240 }),
  ...
  // ═══════════════════════════════════════════════
    ...
    const CW         = [500, 4800, 1600, 2442]; // soma = 9342 = CONTENT_W

    children = [
      ...cabecalho(),
      prC([ar(, { bold: true })], { before: 0, after: 80 }),
      prC([ar()], { before: 0, after: 160 }),
      new Table({
