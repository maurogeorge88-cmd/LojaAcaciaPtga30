...
const MODELOS_PADRAO = [
  ...
  },
  {
    ...
    corpo: 'Aos {data_posse}, às {hora_posse}, na Augusta e Respeitável Loja Simbólica {nome_loja}, sob a presidência do Venerável Mestre (Presidente) {vm_nome}. O assunto foi a posse em seus respectivos cargos dos membros, eleitos para o cargo de Venerável Mestre, membros da Diretoria e Comissões da Augusta e Respeitável Loja Simbólica {nome_loja}, gestão {gestao}. Foram empossados os Irmãos:',
...
const VARIAVEIS_DISPONIVEIS = [
  ...
  { var: '{secretario_nome}',          desc: 'Nome do Secretário Sainte' },
  { var: '{secretario_eleito_nome}',   desc: 'Nome do Secretário Eleito (empossado)' },
  { var: '{vm_eleito_nome}',            desc: 'Nome do VM Eleito' },
