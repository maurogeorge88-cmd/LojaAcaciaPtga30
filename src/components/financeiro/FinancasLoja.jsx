    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => {
              // Abrir modal e resetar formulário
              setFormParcelamento({
                tipo: 'despesa',
                categoria_id: '',
                descricao: '',
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={async (e) => {
              ...
              <div className="flex gap-3 pt-4 border-t">
                <button type="submit" className="flex-1 px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-medium">
                  🔢 Criar Parcelamento
                </button>
                <button type="button" onClick={() => setMostrarModalParcelamento(false)}
                  className="px-6 py-2 bg-gray-300 rounded-lg hover:bg-gray-400 font-medium">Cancelar</button>
              </div>
            </form>
          </div>
        </div>
            ...
            <form onSubmit={async (e) => {
              ...
              {formPagamentoParcial.valor_a_pagar && (
                <div className="bg-blue-50 border border-blue-200 rounded p-3 text-sm">
                  ...
                  <p className="text-blue-700">• Pago: R$ {((parseFloat(lancamentoPagamentoParcial.valor_pago) || 0) + (parseFloat(formPagamentoParcial.valor_a_pagar) || 0)).toFixed(2)}</p>
                  <p className="text-blue-700">• Resta: R$ {((parseFloat(lancamentoPagamentoParcial.valor_restante || lancamentoPagamentoParcial.valor)) - (parseFloat(formPagamentoParcial.valor_a_pagar) || 0)).toFixed(2)}</p>
